...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION DBD_TTB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,1   ),GAD ,ZERO    ,ZERO    ,W(1,5   ))    
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,5   ),GAU ,AMP(1   ))            
      CALL JIOXXX(W(1,2   ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,6   ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          DBD_TTB =DBD_TTB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
