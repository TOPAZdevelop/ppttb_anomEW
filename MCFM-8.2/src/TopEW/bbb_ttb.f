...
C  
C FOR PROCESS : b b~ -> t t~  
C  
C Crossing   1 is b b~ -> t t~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION BBB_TTB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER (NGRAPHS=   6,NEIGEN=  2,NEXTERNAL=4)   
...
C ----------
      ...
      CALL IOVXXX(W(1,4   ),W(1,2   ),W(1,5   ),GWF ,AMP(1   ))            
      CALL HIOXXX(W(1,1   ),W(1,3   ),XWMQ ,XWMASS  ,ZERO    ,W(1,         
     &     6   ))                                                          
      CALL IOSXXX(W(1,4   ),W(1,2   ),W(1,6   ),XWPQ ,AMP(2   ))           
      CALL JIOXXX(W(1,1   ),W(1,2   ),GAD ,ZERO    ,ZERO    ,W(1,7   ))    
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,7   ),GAU ,AMP(3   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,8   ))    
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,8   ),GZU ,AMP(4   ))            
      CALL HIOXXX(W(1,1   ),W(1,2   ),GHBOT ,HMASS   ,HWIDTH  ,W(1,        
     &     9   ))                                                          
      CALL IOSXXX(W(1,4   ),W(1,3   ),W(1,9   ),GHTOP ,AMP(5   ))          
      CALL HIOXXX(W(1,1   ),W(1,2   ),XZB ,XZMASS  ,ZERO    ,W(1,10  ))    
      CALL IOSXXX(W(1,4   ),W(1,3   ),W(1,10  ),XZT ,AMP(6   ))            
      JAMP(   1) = +AMP(   1)+AMP(   2) 
      JAMP(   2) = -AMP(   3)-AMP(   4)-AMP(   5)*0 -AMP(   6)*0 ! removing the s-channel scalars
      BBB_TTB = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          ENDDO
          BBB_TTB =BBB_TTB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
