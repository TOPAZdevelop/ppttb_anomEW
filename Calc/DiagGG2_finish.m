...
DiagPhipmBox=TheRedAmpList[[7]]  //.{ PreFac-> EL^2*GS^4*SW^(-2)*MW^(-2)*Pi^2 , Sqrt2->Sqrt[2] } //. insertMT   // Collect[#,SI[___],Simplify]&;
% //. voL-> 0 
...
bx4 = DiagPhipmBox/PreFacDiagPhipmBox  //. convertToMCFM // Collect[#,{xI1[___],xI2[___],xI3[___],xI4[___]},FullSimplify]&  // FortranForm
...
DiagPhipmSVertRENORM = 2*( DiagPhipmSVert + CTDiagPhipmSVert )  // Collect[#,SI[___],FullSimplify]&
...
(* convert to MCFM *)
vrts4 = DiagPhipmSVertRENORM/PreFacDiagPhipmSVert  //. convertToMCFM // Collect[#,{xI1[___],xI2[___],xI3[___],xI4[___],DB0[___]},FullSimplify]&  // FortranForm
...
DiagPhipmVertRENORM = 2*( DiagPhipmVert + CTDiagPhipmVert )  // Collect[#,SI[___],Simplify]&
...
(* convert to MCFM *)
vrt4 = DiagPhipmVertRENORM/PreFacDiagPhipmVert  //. convertToMCFM // Collect[#,{xI1[___],xI2[___],xI3[___],xI4[___],DB0[___]},FullSimplify]&  // FortranForm 
...
MassCTPhipm =MassCTPhipm   //. {dMf1[3,3]-> delM[MT^2], dZfL1[__]-> delZiifL[MT^2],  dZfR1[__]-> delZiifR[MT^2] }   //. EWCounterterms //. {ID[phi]-> 1, ID[__]-> 0, alpha-> EL^2/(4 Pi), Sqrt[MT^2]-> MT, SU2Flip[MT^2]-> MB^2 }  // Limit[#,MB->0 ]& // Limit[#,SI[1,0]->0 ]&  // Expand; 
MassCTPhipm = MassCTPhipm  //. InsertFinitePartSquared //. DSTm4->0  //. insertMT // Simplify;
UVCheck = MassCTPhipm  //. InsertUVDiv //. insertMT // Series[#,{DSTm4,0,-1}]& // Normal // Factor


DiagPhipmSelfRENORM = 2*( DiagPhipmSelf + MassCTPhipm )  // Simplify
...
(* convert to MCFM *)
slf4 = DiagPhipmSelfRENORM/PreFacDiagPhipmSelf  //. convertToMCFM  // Collect[#,{xI1[___],xI2[___],xI3[___],xI4[___],DB0[___]},FullSimplify]&  // FortranForm  
