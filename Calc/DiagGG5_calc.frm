...
id DID(12)*LoopDenom(p2-p3+q1,MH)*Ga(DumStr1?,q1) = DID(12)*Ga(DumStr1,q1-p2+p3)*LoopDenom(q1,MH);
id DID(12)*LoopDenom(p2-p3+q1,MH)*(q1.pDumX?)     = DID(12)*(q1.pDumX-p2.pDumX+p3.pDumX)*LoopDenom(q1,MH);
id DID(12)*LoopDenom(p2-p3+q1,MH)                 = DID(12)*LoopDenom(q1,MH);
...
***this shoudl be equivalent***id DID(1)*LoopDenom(p3+q1,MT, -p4+q1,MT)*q1.q1 = DID(1)*( LoopDenom(q1,MT) + (MH^2-2*q1.p3+p3.p3)*LoopDenom(q1,MH, -p3-p4+q1,MT) );  
...
* for box [9,1] the LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT) is multiplied at max. with q1^3 and Ga(q1)*Ga(q1) terms are eliminated

id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*(q1.pDumX?)*(q1.pDumY?)*(q1.pDumZ?)     = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*(q1.pDumX-p2.pDumX)*(q1.pDumY-p2.pDumY)*(q1.pDumZ-p2.pDumZ); 
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*(q1.pDumX?)*(q1.pDumY?)*Ga(DumStr1?,q1) = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*(q1.pDumX-p2.pDumX)*(q1.pDumY-p2.pDumY)*Ga(DumStr1,q1-p2); 
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*q1.q1*(q1.pDumX?)                       = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*(q1.q1+p2.p2-2*q1.p2)*(q1.pDumX-p2.pDumX);
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*q1.q1*Ga(DumStr1?,q1)                   = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*(q1.q1+p2.p2-2*q1.p2)*Ga(DumStr1,q1-p2);
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*q1.q1                                   = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*(q1.q1+p2.p2-2*q1.p2);
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*(q1.pDumX?)*(q1.pDumY?)                 = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*(q1.pDumX-p2.pDumX)*(q1.pDumY-p2.pDumY);
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*Ga(DumStr1?,q1)*(q1.pDumY?)             = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*Ga(DumStr1,q1-p2)*(q1.pDumY-p2.pDumY);
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*(q1.pDumX?)                             = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*(q1.pDumX-p2.pDumX);
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)*Ga(DumStr1?,q1)                         = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT)*Ga(DumStr1,q1-p2);
id DID(9)*LoopDenom(p2+q1,MT,p2-p3+q1,MH,-p1+q1,MT)                                         = DID(9)*LoopDenom(q1,MT,-p3+q1,MH,-p1-p2+q1,MT);


* for vertex [3/4,1] no q1 multipy the LoopDenom(...)*q1.q1

id DID(3)*LoopDenom(-p4+q1,MH,-p1+q1,MT)*q1.q1 = DID(3)*LoopDenom(q1,MH,-p1+p4+q1,MT)*(q1.q1+p4.p4+2*q1.p4);
id DID(4)*LoopDenom(-p2+q1,MT,-p3+q1,MH)*q1.q1 = DID(4)*LoopDenom(q1,MT,-p3+p2+q1,MH)*(q1.q1+p2.p2+2*q1.p2);

id DID(3)*LoopDenom(-p4+q1,MH,-p1+q1,MT)*(q1.pDumX?)     = DID(3)*LoopDenom(q1,MH,-p1+p4+q1,MT)*(q1.pDumX+p4.pDumX);
id DID(3)*LoopDenom(-p4+q1,MH,-p1+q1,MT)*Ga(DumStr1?,q1) = DID(3)*LoopDenom(q1,MH,-p1+p4+q1,MT)*Ga(DumStr1,q1+p4);
id DID(3)*LoopDenom(-p4+q1,MH,-p1+q1,MT)                 = DID(3)*LoopDenom(q1,MH,-p1+p4+q1,MT);
id DID(4)*LoopDenom(-p2+q1,MT,-p3+q1,MH)*(q1.pDumX?)     = DID(4)*LoopDenom(q1,MT,-p3+p2+q1,MH)*(q1.pDumX+p2.pDumX);
id DID(4)*LoopDenom(-p2+q1,MT,-p3+q1,MH)*Ga(DumStr1?,q1) = DID(4)*LoopDenom(q1,MT,-p3+p2+q1,MH)*Ga(DumStr1,q1+p2);
id DID(4)*LoopDenom(-p2+q1,MT,-p3+q1,MH)                 = DID(4)*LoopDenom(q1,MT,-p3+p2+q1,MH);
...
Global [13,1,1] = ([13,1]+[14,1]+[15,1])*([cc13,1]+[cc14,1]+[cc15,1]);
Global [14,1,1] = ([13,1])*([cc13,1]+[cc14,1]+[cc15,1]);
Global [15,1,1] = ([15,1])*([cc13,1]+[cc14,1]+[cc15,1]);
Global [1,1,1] =  [1,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [2,1,1] =  [2,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [3,1,1] =  [3,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [4,1,1] =  [4,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [5,1,1] =  [5,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [6,1,1] =  [6,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [7,1,1] =  [7,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [8,1,1] =  [8,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [9,1,1] =  [9,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [10,1,1]= [10,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [11,1,1]= [11,1]*([cc13,1]+[cc14,1]+[cc15,1]);
Global [12,1,1]= [12,1]*([cc13,1]+[cc14,1]+[cc15,1]);
.sort
