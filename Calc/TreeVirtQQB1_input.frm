...
* 1:tree, 2:G0-vertex, 3:Gpm-vertex, 4: Higgs-vertex



Global [1,1] = (i_*DID(0)*MeT(Lor1, Lor2)*PropDenom(p3 + p4, 0)*SumOver(Col1, 3, External)*SumOver(Col2, 3, External)*SumOver(Col3, 3, External)*SumOver(Col4, 3, External)*SumOver(GluInt5, 8, Internal))*(ASpi(1, p2, -MU)*(-(i_*GS*Ga(1, Lor1)*Chir(1, -1)*SUNT(GluInt5, Col2, Col1)) - i_*GS*Ga(1, Lor1)*Chir(1, 1)*SUNT(GluInt5, Col2, Col1))*Spi(1, p1, MU))*(ASpi(2, p3, MT)*(-(i_*GS*(1+dZfL)*Ga(2, Lor2)*Chir(2, -1)*SUNT(GluInt5, Col3, Col4)) - i_*GS*(1+dZfR)*Ga(2, Lor2)*Chir(2, 1)*SUNT(GluInt5, Col3, Col4))*Spi(2, p4, -MT));
#define NumSM1 "2" 


Global [2,1] = (DID(2)*LoopDenom(q1, MZ, p3 + q1, MT, -p4 + q1, MT)*MeT(Lor1, Lor2)*PropDenom(p3 + p4, 0)*SumOver(Col1, 3, External)*SumOver(Col2, 3, External)*SumOver(Col3, 3, External)*SumOver(Col4, 3, External)*SumOver(GluInt5, 8, Internal))*
...
Global [3,1] = (DID(3)*LoopDenom(q1, MW, p3 + q1, MB, -p4 + q1, MB)*MeT(Lor1, Lor2)*PropDenom(p3 + p4, 0)*SumOver(Col1, 3, External)*SumOver(Col2, 3, External)*SumOver(Col3, 3, External)*SumOver(Col4, 3, External)*SumOver(GluInt5, 8, Internal))*
(ASpi(1, p2, -MU)*(-(i_*GS*Ga(1, Lor1)*Chir(1, -1)*SUNT(GluInt5, Col2, Col1)) - i_*GS*Ga(1, Lor1)*Chir(1, 1)*SUNT(GluInt5, Col2, Col1))*Spi(1, p1, MU))*
(ASpi(2, p3, MT)*(
